...
internal class InitialData
{
    ...
    new List<User>
    {
            ...
            User.Create(new Guid("4f136e9f-123c-32b1-844c-e6f3b70b9d8c"), "Ada Nowa"),
    };
    ...
    new List<Domain.Models.Task>
    {
            ...
            Domain.Models.Task.Create(Guid.NewGuid(), new Guid("4f136e9f-123c-32b1-844c-e6f3b70b9d8c"), "Task #1", "Fixing #1", new DateTime(2024,11,25)),
    };
}
